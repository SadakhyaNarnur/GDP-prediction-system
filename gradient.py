...
# Modelling GBTRegressor and fitting the model
gbtr = GBTRegressor(featuresCol='features', labelCol='label', maxIter=10)
gbtr = gbtr.fit(assemble)
predictions = gbtr.transform(assemble_test)
predictions.show(3)
...
mae = mean_evaluator.evaluate(predictions)
print("R squared",r2)
print("Root Mean Square Error",rmse/10000)
print("Mean Absolute Error",mae/10000)
